      ...
      <div class="row">
        ...
        <div class="ibox-content">
          <div class="panel panel-default">
            <div class="panel-heading"><h3><i class="fa fa-mobile"></i> Send Individual SMS</h3></div>
            <div class="panel-body">
              <form method="post" action="<?php echo site_url('send_individual_sms')?>" class="form-horizontal">
