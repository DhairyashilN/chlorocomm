      ...
      <div class="row">
        ...
        <div class="ibox-content">
          <div class="text-right" style="margin-bottom:20px;">
            <a href="<?php echo site_url('add_type');?>" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Add New</a>
          </div>
            ...
            <table id="example1" class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?php echo site_url('edit_type/'.$row['id']);?>" class="btn btn-primary btn-xs" title="Edit"><i class="fa fa-pencil"></i></a>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-body text-center">
                            ...
                            <a href="<?php echo site_url('chlorocomm/delete_category/'.$row['id']);?>"><button type="button" class="btn btn-danger" >Yes</button></a>&nbsp;&nbsp;
